...
class Trip_tipps {
    ...
    int distance(String origin,String destination ) {
        ...
        if (results.status == "OK") {
            ...
            distance = results.routes[0].legs[0].distance.value as int   // minutes
            duration = results.routes[0].legs[1].duration.value as int   // seconds
