...
<div class="fieldcontain ${hasErrors(bean: connectionInstance, field: 'co2', 'error')} ">
	<label for="co2">
		<g:message code="connection.co2.label" default="Co2" />
		
	</label>
	<g:field type="number" name="co2" value="${fieldValue(bean: connectionInstance, field: 'co2')}"/>
</div>
