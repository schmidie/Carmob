				...
				<table class="table table-striped">
					<thead>
						<tr>
							...
							<g:sortableColumn property="distance" title="${message(code: 'connection.distance.label', default: 'Distance')}" />
					...
					<g:each in="${connectionInstanceList}" var="connectionInstance">
						<tr>
							...
							<td>${fieldValue(bean: connectionInstance, field: "distance")}</td>
